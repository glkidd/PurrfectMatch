...
public class TestClass {
    ...
    /*
     * @Test public void TestContactPageAsEmployee() { WebDriver driver = new
     * ChromeDriver(); driver.get("localhost:3000");
     * 
     * try { Thread.sleep(3000); } catch (Exception e) { }
     * 
     * // Navigate to contact page driver.findElement(By.id("contactLink")).click();
     * 
     * // Type name "Bob" into element w/id firstNameField
     * driver.findElement(By.id("firstNameField")).findElement(By.xpath("./input")).
     * sendKeys("Bob");
     * 
     * // Type name "Lincoln" into element w/id lastNameField
     * driver.findElement(By.id("lastNameField")).findElement(By.xpath("./input")).
     * sendKeys("Lincoln");
     * 
     * // Select "yes" for new new
     * Select(driver.findElement(By.id("shelterEmployeeSelectionBox")).findElement(
     * By.xpath("./select"))) .selectByIndex(1);
     * 
     * // Type email "user@woodshumanesociety.org" into element w/id
     * emailAddressField
     ...
     * driver.findElement(By.id("subjectField")).findElement(By.xpath("./input")).
     * sendKeys("Success Stories Page Bug");
     * 
     ...
     * driver.findElement(By.id("submitButton")).findElement(By.xpath("./button")).
     * click();
     * 
     * try { Thread.sleep(5000); } catch (Exception e) { }
     * 
     ...
     * driver.close(); }
     * 
     * @Test public void TestSuccessStoriesPage() { WebDriver driver = new
     * ChromeDriver(); driver.get("localhost:3000");
     * 
     * try { Thread.sleep(3000); } catch (Exception e) { }
     * 
     ...
     * driver.close(); }
     * 
     * @Test public void TestSearchResultsPage() { WebDriver driver = new
     * ChromeDriver(); driver.get("localhost:3000");
     * 
     * try { Thread.sleep(1000); } catch (Exception e) { }
     * 
     ...
     * driver.close(); }
     * 
     * @Test public void TestContactPageAsNonEmployee() { WebDriver driver = new
     * ChromeDriver(); driver.get("localhost:3000");
     * 
     * try { Thread.sleep(3000); } catch (Exception e) { }
     * 
     ...
     * sendKeys("Lincoln");
     * 
     * // Select "no" for new new
     * Select(driver.findElement(By.id("shelterEmployeeSelectionBox")).findElement(
     * By.xpath("./select"))) .selectByIndex(2);
     * 
     * // Type email "tgorer@calpoly.edu" into element w/id emailAddressField
     * driver.findElement(By.id("emailAddressField")).findElement(By.xpath("./input"
     * )).sendKeys("tgorer@calpoly.edu");
     * 
     * // Type subject "Success Stories Page Bug" into element w/id subjectField
     * driver.findElement(By.id("subjectField")).findElement(By.xpath("./input")).
     * sendKeys("Success Stories Page Bug");
