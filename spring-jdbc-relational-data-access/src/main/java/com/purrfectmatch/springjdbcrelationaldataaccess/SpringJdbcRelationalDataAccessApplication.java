...
public class SpringJdbcRelationalDataAccessApplication implements CommandLineRunner {
	private static final Logger log = LoggerFactory.getLogger(SpringJdbcRelationalDataAccessApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(SpringJdbcRelationalDataAccessApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		jdbcTemplate.update("INSERT INTO SuccessStory(id, imageName, name, " +
				"age, storyText, breed, gender, adoptionDate, owner) VALUES (?,?,?,?,?,?,?,?,?)", successStories.get(0));
	}
}
